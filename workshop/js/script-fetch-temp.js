...
function showFullInfo() {
  ...
  if (this.dataset.type === "movie") {
    ...
    url = url = `${apiHost}/3/tv/${
      this.dataset.id
    }?api_key=${apiKey}&language=ru-RU`;
  } else {
    movie.innerHTML =
      '<h2 class="col-12 text-center text-danger">Произошла ошибка. Повторите запрос позже </h2>';
  }
  ...
  fetch(url)
    ...
    .then(output => {
      ...
      <div class ="col-4 bg-light p-5"> 
       ...
       ${
         output.homepage != 0
           ? `<p class="text-center text-info mb-2"> <a href="${
               output.homepage
       ...
       ${
         output.imdb_id
           ? `<p class="text-center text-info mb-2"> <a href="https://www.imdb.com/title/${
               output.imdb_id
      ...
      <p class="badge badge-success p-3">Премьера: ${output.first_air_date ||
